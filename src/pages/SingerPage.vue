<template>
    <div class="table">
        ...
        <el-table size="mini" border style="width:100%" height="550px" :data="data">
        ...
        <el-dialog title="添加歌手" :visible.sync="centerDialogVisible" width="400px" center>
            <el-form :model="registerForm" ref="registerForm" label-width="80px">
                ...
                <el-form-item prop="introduction" label="简介" size="mini">
                    <el-input v-model="registerForm.introduction" placeholder="简介" type="textarea" style=""></el-input>
                </el-form-item>
            </el-form>
            <span slot="footer">
                <el-button type="primary" size="small" @click="centerDialogVisible=false">取消</el-button>
                <el-button type="primary" size="small" @click="addSinger">确定</el-button>
            </span>
        </el-dialog>
<!-- 修改弹窗 -->
         <el-dialog title="添加歌手" :visible.sync="editVisible" width="400px" center>
            <el-form :model="editForm" ref="editForm" label-width="80px">
                ...
                <el-form-item prop="introduction" label="简介" size="mini">
                    <el-input v-model="editForm.introduction" placeholder="简介" type="textarea" style=""></el-input>
                </el-form-item>
            </el-form>
            <span slot="footer">
   ...
   created(){
    ...
    methods:{
        ...
        addSinger(){
            ...
            params.append("picture","/img/user.jpg");
